...
parser.add_argument('--trial', type=str, default='final7', help='trial id')
...
parser.add_argument('--lambda_ssl', type=float, default=0.3, help='loss weight for reconstruction loss')
parser.add_argument('--lambda_ssl2', type=float, default=0.35, help='loss weight for reconstruction loss')
parser.add_argument('--lambda_ssl3', type=float, default=0.35, help='loss weight for reconstruction loss')
...
if args.pretrain:
    args.lambda_cls = 0.0
    args.lambda_ssl = 0.3
    args.lambda_ssl2 = 0.35
    args.lambda_ssl3 = 0.35
